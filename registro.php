...
<body>
    <div class="Contenedor">
        <div class="login">
            ...
            <form action="registrosdb.php" method="POST">
                <label>
                    <span class="datos">Usuario hola</span><br>
            ...
            <span class="registro">Ya tienes cuenta <a href="index.php">Inicia Sesion</a></span>
        </div>
    </div>
